  ...
  return (
    <section className="py-20 bg-[#f8f8f8] dark:bg-[#111111] ">
      ...
      <div className="container max-w-8xl mx-auto ">
        <div className="absolute top-0 right-5 z-10 p-2 ">
          <ScanFace size={20} className="text-primary/50 hover:text-primary" />
        </div>
        ...
        >
          ...
          <Card className="w-full rounded-lg border border-border/20 shadow-sm backdrop-blur-sm bg-background/80">
            <CardHeader className="relative pb-6">
              ...
              >
                <ScanFace className="text-primary/70" size={24} />
              </motion.div>
              <motion.div
                initial={{ opacity: 0, y: -10 }}
                animate={{ opacity: 1, y: 0 }}
              ...
              >
                <CardTitle className="text-2xl text-foreground/90 tracking-wider font-bold">
                  Hobbies & Interests
                </CardTitle>
                <CardDescription className="mt-2">
        ...
        >
          <Card className="rounded-lg border border-border/20 shadow-sm backdrop-blur-sm bg-background/80"></Card>
        </motion.div>
      </div>
    </section>
  );
